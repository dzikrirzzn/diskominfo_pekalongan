        ...
        <div class="container mx-auto flex justify-between items-center flex-wrap">
            ...
            <div :class="{'hidden': !isOpen, 'block': isOpen}" class="w-full lg:flex lg:items-center lg:w-auto">
                <ul class="lg:flex space-y-2 lg:space-y-0 lg:space-x-10">
                    ...
                    <li><a href="{{ route('listberita') }}" class="block text-black hover:text-gray-200">Berita</a></li>
        ...
        <div class="flex flex-col md:flex-row md:space-x-4">
            ...
            <div class="flex-1">
                <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                    <h1 class="text-3xl font-bold mb-2">Wali Kota Aaf Monitoring Warga Terdampak Banjir di Pengungsian
                    </h1>
                    <div class="text-gray-600 text-sm mb-4">
                        <span>Ditulis oleh Tim Komunikasi Publik</span> | <span>15 Maret 2024 [08:23:44]</span> |
                    ...
                    <p class="leading-7 mb-4">Banjir di sejumlah titik di Kota Pekalongan membuat ratusan orang
                        mengungsi di beberapa titik pengungsian. Wali Kota Pekalongan, Achmad Afzan Arslan Djunaid
                        langsung melakukan monitoring ke lokasi pengungsian di Ar-Robbitoh Klego dan Aula Kecamatan
                        Pekalongan Barat, Kamis sore (14/3/2024).</p>
                    <p class="leading-7 mb-4">Wali Kota Aaf, sapaan akrabnya melihat langsung kondisi warganya di
                        pengungsian
                        memastikan semuanya terlayani dengan baik dan dalam keadaan sehat.</p>
                    <p class="leading-7">Aaf mengungkapkan bahwa intensitas hujan luar biasa 2 hari ini, sejak kemaren
                        sore sampai tadi dini hari hingga mengakibatkan banjir terutama di wilayah Pekalongan Barat dan
                        Pekalongan Timur. "Di Pekalongan Barat ada 380 pengungsi dan di Pekalongan Timur ada 209
                        pengungsi," kata Aaf.

                        Jumlah pengungsi tidak seperti tahun sebelumnya, apalagi untuk Pekalongan Utara ini sudah ada
                        rumah pompa sehingga ketika banjir langsung segera surut. "Untuk di Klego dan Poncol ini ada
                        rumah pompa tapi belum resmi dan dioperasionalkan sehingga bersamaan dengan intensitas hujan
                        tinggi dan rob naik membuat banjir," jelas Aaf.

                        Aaf berharap kebutuhan para pengungsi terakomodasi semua. Tadi juga ada pengungsi yang dalam
                        kondisi lemas langsung dirujuk ke rumah sakit. "Semoga semuanya dalam kondisi sehat wal afiat,
                        kalau ada apa-apa tolong koordinasi ya, jangan saling menyalahkan," tandas Aaf.

                        Kejadian ini merupakan faktor alam, memang tidak semua terdampak, namun Aaf berpesan jika ada
                        permasalahan lingkungan misalnya banyaknya eceng gondok silahkan didiskusikan, dari pemkot,
                        TNI/Polri siap bersama menyelesaikan permasalahan lingkungan. "Ini saatnya kita bersama bukan
                        saling menyalahkan," tegas Aaf.

                        Dari pantauan Aaf untuk dapur umum belum dibutuhkan tapi perihal logistik untuk sahur dan
                        berbuka puasa tetap disiapkan, termasuk untuk anak-anak yang tidak puasa juga disuplai
                        logistiknya. </p> <!-- Add more content as needed -->
                </div>
            </div>
            <!-- Sidebar -->
