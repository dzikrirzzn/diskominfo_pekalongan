...
<body class="bg-gray-100 text-gray-800">
    ...
    <!-- Halaman Berita -->
    <!-- Banner -->
    <div class="relative h-56 sm:h-64 md:h-72 lg:h-80 bg-cover"
        style="background-image: url('{{ asset('img/batik_pkl.png') }}');">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 -mt-24 relative z-10">
        <div class="flex flex-wrap md:flex-nowrap">
            <!-- Main Content -->
            <div class="bg-white p-6 rounded-lg shadow-lg mb-10 md:mb-0 w-full md:w-8/12 md:mr-4"
            ...
            <!-- Sidebar -->
            <div class="w-full md:w-4/12 bg-white p-6 rounded-lg shadow-lg"
        ...
        <footer class="bg-yellow-500 py-12 relative z-50 rounded-t-lg">
