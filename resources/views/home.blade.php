    ...
    <main class="flex-1">
        ...
        <div
            ...
            <div class="bg-white border border-gray-300 rounded-lg shadow-md p-4 w-full lg:w-80">
                ...
                <a class="twitter-timeline" href="https://twitter.com/pemkotpkl">Tweets by Pemkot Pekalongan</a>
                <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
            </div>
            <!-- Twitter feed for @officialbatiktv -->
            <div class="bg-white border border-gray-300 rounded-lg shadow-md p-4 w-full lg:w-80">
                <div class="font-bold mb-4">Postingan dari @officialbatiktv</div>
                <a class="twitter-timeline" href="https://twitter.com/officialbatiktv">Tweets by BATIK TV</a>
                <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
            </div>
        </div>
