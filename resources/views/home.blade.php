...
<body class="flex flex-col min-h-screen bg-white">
    ...
    <main class="flex-1 relative z-0 pt-4 md:pt-8 lg:pt-16 ">
        ...
        <div class="flex flex-col lg:flex-row h-auto lg:h-[92vh]">
            <div id="leftSection"
                class="relative bg-yellow-500 text-white p-6 md:p-12 lg:p-24 flex flex-col justify-start z-10 overflow-hidden shadow-lg"
                style="min-height: 500px; border-top-right-radius: 10% 70%; border-bottom-right-radius: 10% 80%; clip-path: ellipse(100% 130% at 0% 55%); animation: slideInLeft 1s ease-out;">
                <h1 class="text-3xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-8 mt-20 animate-fadeIn">Welcome
                    to<br>City
                    of<br>Pekalongan</h1>
                <p class="mb-4 md:mb-8 text-lg md:text-xl lg:text-2xl animate-fadeIn">World City of Batik</p>
                <div class="relative animate-fadeIn">
                    <input type="text" placeholder="How can we help?"
                        class="w-full p-3 md:p-4 pr-12 rounded-full text-black text-lg md:text-xl">
                    <button
                        class="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-800 transition duration-300 focus:outline-none">
            ...
            <div id="rightSection" class="relative lg:w-5/12 flex items-center justify-end lg:h-screen z-0">
                <div class="swiper-container w-auto h-full transition-transform duration-500 ease-in-out">
                    <div class="swiper-wrapper vh-100 vw-400 mx-48">
                        @foreach ($headlineBerita as $berita)
                        <div class="swiper-slide w-[500px] max-w-[700px] h-full animate-fadeIn">
                            <a href="{{ route('content.show', ['type' => 'headline', 'id' => $berita->id]) }}">
                                <img src="{{ asset('storage/' . $berita->image) }}" alt="{{ $berita->title }}"
                                    class="carousel-image w-[400vh] h-auto object-cover transition-transform duration-500 ease-in-out hover:scale-95">
                            </a>
                        </div>
                        @endforeach
                    </div>
        ...
        <!-- carousel travel -->
        <div class="flex justify-between items-center mx-4 md:mx-16 mt-10 mb-4">
            <h2 class="text-2xl font-bold">Rekomendasi Wisata</h2>
            <a href="{{ route('travel.list', ['type' => 'travel']) }}" class="text-blue-600 hover:underline">Lihat
                Semua</a>
        </div>
            ...
            <div class="container mx-auto py-8 px-4">
                ...
                <div class="swiper-container first-carousel">
                    <div class="swiper-wrapper">
                        ...
                        <a href="{{ route('content.show', ['type' => 'galeri', 'id' => $gallery->id]) }}"
                            class="flex justify-between w-full no-underline">
