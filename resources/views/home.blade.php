...
<body class="flex flex-col min-h-screen bg-white">
        ...
        <div class="w-full lg:w-1/2 bg-yellow-500 text-white p-12 lg:p-24 flex flex-col justify-center half-circle">
            ...
            <div class="relative">
                <input type="text" placeholder="How can we help?"
                    class="w-full p-4 pr-12 rounded-full text-black placeholder-lg"> <!-- Gunakan kelas placeholder-lg -->
    ...
    <div class="container mx-auto p-4">
        <div class="overflow-hidden rounded-lg shadow-lg my-8 mx-auto max-w-screen-lg">
...
<!-- Berita & Pengumuman -->
<div class="relative h-screen mb-8"> <!-- Menambahkan margin bottom -->
    ...
    <div class="container mx-auto py-8 px-4 h-full relative z-10">
        <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 h-full px-4 md:px-20">
            ...
            <div class="flex-1 md:flex-[3] bg-transparent rounded-lg p-4 h-full flex flex-col">
                <h2 class="text-2xl md:text-3xl font-semibold mb-4 text-white border-b-2 border-gray-300">Berita Kota</h2>
...
<!-- Galeri Kota -->
<div class="container mx-auto py-8 px-4 mb-12"> <!-- Menambahkan margin bottom -->
...
<!-- Kalender Acara -->
<div class="container mx-auto p-2 lg:p-4 relative mt-8 mb-6"> <!-- Menambahkan margin top dan bottom -->
...
<div class="container mx-auto py-8 px-4 mb-8"> <!-- Menambahkan margin-bottom -->
...
<!-- Swiper CSS -->
<div class="container mx-auto py-8 px-4 mb-6"> <!-- Menambahkan margin-bottom -->
    <div class="bg-white shadow-lg rounded-lg p-6"> <!-- Menghapus margin-top -->
